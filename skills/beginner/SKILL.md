...
name: beginner
description: >-
  Pepper beginner questions or dump a naive question list to map the common baseline. Triggers: beginner, beginner questions, socratic, naive questions, beginner list. Part of VIDEO IDEAS.
...
Short context block: identity, craft, experience, niche. Optional: topic to focus the beginner on.
...
1. Ask for context: who you are, what you do, what you have experience in. Optional topic focus.
...
User has a question list, or Socratic dialogue has surfaced enough beginner edges. User picks what to develop.

## Output

Question list and/or dialogue → optional map of strongest questions to video ideas (user picks).
...
Input: "I'm a freelance bookkeeper, 8 years, QuickBooks + small biz taxes."

List mode output (fragment): What is bookkeeping vs accounting? Do I need QuickBooks or can I use a spreadsheet? What receipts do I actually need to save? When do I hire a bookkeeper vs do it myself? What's a chart of accounts?
